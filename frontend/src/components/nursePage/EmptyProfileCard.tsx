...
const EmptyProfileCard = ({ nurse }: { nurse: NurseType }) => {
    ...
    return (
        <div className="flex flex-col justify-center items-center w-full m-4 p-5 rounded-lg ">
            <div className="flex flex-col justify-center items-center w-1/2 m-4 p-5 rounded-lg ">
