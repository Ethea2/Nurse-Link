...
const EmptyProfileCard = ({ nurse }: { nurse: NurseType }) => {
    ...
    return (
        <div className="flex flex-col justify-center items-center w-1/2 border-2 m-4 p-5 rounded-lg ">
            ...
            {isOwnProfile ? ( 
                ...
                <div className="font-bold text-2xl">Building Profile, One Detail at a Time!</div>
            )}
