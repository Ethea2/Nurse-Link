...
// Set up the logic for conditional rendering, also added the nurse data na.
  return (
    <div className="detailsContainer flex flex-col w-full rounded-lg font-open-sans">
      {nurse?.about && (
        <div className="introduction flex flex-col w-full border-2 px-10 py-8 rounded-lg mb-5">
          {/* {nurse?.about} */}
      ...
      <div className="education flex flex-col w-full border-2 px-10 py-8 rounded-lg mb-5 text-outline-text">
        <div className="title text-3xl font-bold">Education</div>
        <div className="educationDetails font-pt-sans text-xl pt-5">
      ...
      <div className="experience flex flex-col w-full border-2 px-10 py-8 rounded-lg mb-5 text-outline-text">
        <div className="title text-3xl font-bold">Experience</div>
        <div className="experienceDetails flex font-pt-sans text-xl pt-5">
      ...
      <div className="volunteering flex flex-col w-full border-2 px-10 py-8 rounded-lg mb-5 text-outline-text">
      ...
      <div className="licenses flex flex-col w-full border-2 px-10 py-8 rounded-lg mb-5 text-outline-text">
        <div className="title text-3xl font-bold">Licenses</div>
        <div className="experienceDetails flex font-pt-sans text-xl pt-5">
          <div className="leftContainer pr-5">
            <PiFileBold className="w-8 h-8" />
          </div>
          <div className="rightContainer w-1/8">
      ...
      <div className="certifications flex flex-col w-full border-2 px-10 py-8 rounded-lg mb-5 text-outline-text">
      ...
      <div className="awards flex flex-col w-full border-2 px-10 py-8 rounded-lg mb-5 text-outline-text">
