import {
  ...
  import { nowTimeStamp } from "../chatFunctions/dates";
  import { getOtherUser } from "../chatFunctions/getOtherUser";
  import { useIsMobile } from "../chatFunctions/isMobile";
  
  import { privateKey, projectId } from "../chatFunctions/constants";
