...
import PreferencesCards from "../../components/settings/PreferencesCards"
        ...
        <div className="flex md:p-20 w-full min-h-screen">
            <div className="flex flex-col w-[25%] mr-10">
                ...
                <Link to={`/nurse/settings/preferences/${userId}`}>
                    <p className="text-xl mt-3 font-open-sans text-secondary underline">Preferences</p>
                </Link>
                <Link to={`/nurse/settings/management/${userId}`}>
                    <p className="text-xl mt-3 font-open-sans">Management</p>
                </Link>
            </div>
            <Suspense fallback={<div>Loading...</div>}>
                <div className="flex flex-col w-[75%]">
                    <p className="text-5xl font-open-sans font-bold text-primary mb-8">Preferences</p>
                    <PreferencesCards nurse={nurseId} />
                </div>
            </Suspense>
        </div>
    )
